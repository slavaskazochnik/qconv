...
IS
  ...
  ALTER TABLE POINT ADD CONSTRAINT POINT_UK UNIQUE(STREET_ID, HOUSE_NUM) ;
...
IS
  ...
  ALTER TABLE USER_ROLE ADD CONSTRAINT USER_ROLE_UNIQ UNIQUE(USER_PROFILE_ID, APP_ROLE_ID) ;
...
-- Error - Foreign Key ORADERS_TIMETABLE_STATE_FK has no columns
...
-- Error - Foreign Key ORDERS_ORDERS_RESULT_FK has no columns

-- Error - Foreign Key ORDERS_ORDERS_STATE_FK has no columns
