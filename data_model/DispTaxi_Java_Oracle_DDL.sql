...
CREATE TABLE AUTOS
  (
    ...
    R_WAITING     SMALLINT,
    R_ROUTE       SMALLINT,
    POSITION_LAT  VARCHAR2(15),
    POSITION_LNG  VARCHAR2(15),
    SIGN_ACTIVE   INTEGER,
    CREATION_DATE DATE
  )
  LOGGING ;
...
CREATE TABLE POINT
  (
    ...
    NAME      VARCHAR2(10),
    POINT_LAT VARCHAR2(15),
    POINT_LNG VARCHAR2(15)
  )
  LOGGING ;
